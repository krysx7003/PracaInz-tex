...
made using WolneLektury.pl API. Doing so, gave access to rich set of literature
...
to imitate handwriting. Additionally dataset contains images affected by 
synthetic distortions, which should simulate realistic degradation of documents
quality.

Next, the created dataset was used in evaluating four different OCRs: DocTR, EasyOCR,
Paddle and Tesseract. Results were analysed by comparing both their accuracy (CER)
and runtime.
...
benchmarking and identifying strong and weak sides of OCRs.
