...
W wyniku skanowania dokumentów powstają obrazy zawierające tekst. Jednakże większość narzędzi do przetwarzania tekstu
nie jest w stanie operować na plikach graficznych. Aby rozwiązać ten problem, można zastosować algorytmy optycznego
rozpoznawania znaków (Optical Character Recognition, OCR). Są to narzędzia, które umożliwiają rozpoznanie tekstu na
...
uczenia maszynowego algorytmy OCR stopniowo zaczęły coraz częściej korzystać z tych technologii. Dzięki 
...
Współcześnie narzędzia te nadal służą osobom z różnymi niepełnosprawnościami. jednak zakres zastosowań algorytmów OCR
...
dokumenty o zróżnicowanej charakterystyce, uwzględniając m.in. różne kroje pisma, a także modyfikacje utrudniające poprawne 
