...
Na przykład:
    ...
    \textbf{Tekst oryginalny: }Życiem wschód, śmiercią południe;

    \textbf{Tekst wygenerowany przez model: }Zyciem wschod, siercia poudniex;
}

Aby przekształcić tekst wygenerowany w tekst oryginalny, należy wykonać 4 zamiany (Brakujące znaki polskie),
