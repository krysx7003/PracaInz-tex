...
zastosowanie w wielu środowiskach, na przykład w grafice komputerowej, w szczególności
podczas proceduralnej generacji tekstur. Z szumu Perlina korzysta się też w produkcji
filmów wykorzystujących grafikę generowaną komputerowo (CGI) oraz w tworzeniu środowisk
w grach komputerowych(np. w grze Minecraft proces generacji terenu korzysta z tego 
algorytmu).
...
\begin{enumerate}
    ...
    \item \textbf{Trwałość (Persistence)} - Współczynnik określający amplitudę kolejnych
        ...
        niskie wartości skutkują bardziej wygładzonymi rezultatami.
