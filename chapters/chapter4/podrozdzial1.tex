...
strukturalny dostęp do zasobów poprzez logiczne end pointy. Serwis WolneLektury.pl
...
\begin{figure}[H]
    ...
    \caption{Widok szczegółowy dla pozycji ballady i romanse}\label{fig:ballady-2}
\end{figure}
