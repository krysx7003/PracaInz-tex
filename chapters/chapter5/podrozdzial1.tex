{\noindent \textbf{Eksperyment 1 \- Porówanie z innymi zbiorami }}
...
{\noindent \textbf{Eksperyment 2 \- Wpływ zniekształceń obrazu }}
    ...
    Drugi eksperyment ma na celu zbadanie wpływu zastosowanych zniekształceń obrazu (opisane
...
{\noindent \textbf{Eksperyment 3 \- Wpływ krojów pisma}}
    ...
    Natomiast celem trzeciego eksperymentu było zbadanie wpływu wybranych krojów pisma (opisanych
