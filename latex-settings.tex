...
\usepackage{mathrsfs}
\usepackage{ragged2e}\usepackage{ragged2e}\usepackage{ragged2e}
...
\fancypagestyle{ListofFiguresStyle}{
	\fancyhf{}									% wyczyść stopki i nagłówki
	\fancyhead[RO]{								% Prawy, nieparzysty nagłówek
		\hrulefill \hspace{16pt} \large Spis ilustracji
		\put(-471.5,5.5){%
			\makebox(0,0)[l]{%
				\small Politechnika Wrocławska
			}
...
\newcommand{\doublepage}{\cleardoublepage\thispagestyle{empty}}
